...
可以在元素标签中插入，诸如
我是笨比
，这相当于设置了一个类名为“woshibenbi”，类的名字是有限制的，英文字符、数字、短横线。还可以把“我是笨比”这句话划为两类、三类，只要第一个class标签后加空格，再写其他标签就好了。最后写法为：.woshibenbi{} (一定要用.号)。如果你想把css写的看起来高级冗杂些，还可以用合并选择器+类选择器，结果是网页变得更卡了......
